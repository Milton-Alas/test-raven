...
class DiagnosticRangeForm
{
    public static function configure(Schema $schema): Schema
    {
        return $schema
            ->components([
                HistoricalContent::notice('rango diagnóstico'),

                Section::make('Rango de Percentiles')
                    ->description('Definen a qué rango corresponde cada percentil. Cambiarlos reinterpretaría resultados ya emitidos.')
                    ->disabledOn('edit')
                    ->schema([
                ...
                Section::make('Etiquetas y Resultados')
                    ->description('Texto que aparece en los informes entregados, por eso no se reescribe al editar.')
                    ->disabledOn('edit')
                    ->schema([
